...
export function BenefitsSection() {
  ...
  return (
    <section id="beneficios" className="py-20 bg-gradient-to-br from-slate-50 to-amber-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Beneficios para todos</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Beneficios para asesores</h3>
          ...
          <div>
            <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Beneficios para quienes nos eligen</h3>
            <div className="space-y-6">
